...
const foodSavingTips = [
  {
    ...
    description:
      "אבוקדו מבשיל תוך 4-5 ימים בטמפרטורת החדר. להאצה, שים אותו בשקית עם בננה או תפוח.",
  },
  {
    tip: "אחסון עשבי תיבול",
    description:
      "שמור עשבי תיבול כמו פטרוזיליה או כוסברה בכוס מים מכוסה בשקית ניילון במקרר – הם יישארו טריים יותר.",
  },
  {
  ...
  },
  {
    tip: "גבינות קשות",
    description:
      "מרח מעט חמאה או שמן זית על הקצוות של גבינה קשה כדי למנוע התייבשות.",
  },
  {
    tip: "אחסון לחם",
    description:
      "שמור לחם בפריזר אם אינך מתכנן להשתמש בו בקרוב. הפשרה בטוסטר תחזיר לו את הטריות.",
  },
  {
    tip: "חיתוך בצל ללא דמעות",
    description:
      "הכנס את הבצל למקפיא למשך 10 דקות לפני החיתוך – זה יקטין את הפרשת הגז שגורם לדמעות.",
  },
  {
    tip: "שימור תותים",
    description:
      "שטוף תותים במים עם מעט חומץ (1:10) והייבש היטב לפני האחסון – זה יאריך את חייהם.",
  },
  {
    tip: "החייאת ירקות רכים",
    description:
      "השרה ירקות רכים כמו גזר או סלרי בקערת מים קרים – הם יחזרו לחיים.",
  },
  {
    tip: "שאריות יין",
  ...
  },
  {
    ...
    description:
      "שמור תפוחי אדמה במקום קריר ויבש עם תפוח עץ – זה יאט את ההנבטה.",
  },
  {
    tip: "שימור פירות יער",
    description:
      "פזר מעט סוכר על פירות יער לפני ההקפאה כדי לשמור על הטעם והמרקם.",
  },
  {
  ...
  },
  {
    ...
    description:
      "אחסן גבינת קוטג' או יוגורט הפוך (המכסה כלפי מטה) כדי למנוע כניסת אוויר ולשמור על הטריות.",
  },
  {
    tip: "שימור ביצים",
    description:
      "בדוק אם ביצה טרייה: שים אותה בכוס מים. אם היא שוקעת, היא טרייה; אם היא צפה, עדיף להשליך אותה.",
  },
  {
    tip: "אחסון תפוחים",
  ...
  },
  {
    ...
    description:
      "חתוך שאריות לחם לקוביות, טגן אותן קלות עם שמן זית ותבלינים כדי ליצור קרוטונים.",
  },
  {
    tip: "הקפאת לימונים",
    description:
      "הקפא לימונים שלמים או סחוטים כדי להשתמש במיץ או קליפה כשצריך.",
  },
  {
    tip: "שימור עגבניות",
    description:
      "עגבניות בשלות ניתן להקפיא בשלמותן ולהשתמש בהן להכנת רטבים או מרקים.",
  },
  {
    tip: "תכנון ארוחות יעיל",
    description:
      "תכנן מראש את הארוחות שלך כדי להשתמש במוצרים שיש בבית לפני שקונים חדשים ולמנוע בזבוז.",
  },
];
...
iHaveEvent.addEventListener("click", () => {
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      const kindOfEventInput =
        document.getElementById("kindOfEventInput").value;
      const sensitivityInput =
        document.getElementById("sensitivityInput").value;
